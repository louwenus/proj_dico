...
type nom = { content: string; gender: genre; count: nb };; (* Le string peut contenir Je/Tu/Nous/Vous qui va influencer la conjugaison *)
...
let (phrase: mot list) = [Nom {content = "Je"; gender = None; count = Sing;}; Verbe {content = "mange"; conjugaison = [Je; Sing3]}];;